...
return array(
    ...
    'does_not_exist' => 'Thành phần không tồn tại.',

    'create' => array(
        'error'   => 'Thành phần đã không được tạo, vui lòng thử lại.',
        'success' => 'Thành phần thành công.'
    ),

    'update' => array(
        'error'   => 'Thành phần đã không được cập nhật, vui lòng thử lại',
    ...
    'delete' => array(
     ...
     'checkout' => array(
        'error'   		=> 'Thành phần đã không được kiểm tra, hãy thử lại',
