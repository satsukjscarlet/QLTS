...
return [
    ...
    'help' => [
        ...
        'deployable'   => 'Những tài sản này có thể được checkin checkout, sau khi checkout sẽ thay đổi trạng thái <i class="fas fa-circle text-blue"></i> <strong>Deployed</strong>.',
